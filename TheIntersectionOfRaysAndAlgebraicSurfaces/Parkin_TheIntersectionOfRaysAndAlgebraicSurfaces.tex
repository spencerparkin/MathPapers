...
\begin{abstract}
It is shown that for any real-valued, multi-variable polynomial defined over the
...
any one point along the line and in a direction of the line.
Though arrived at independantly in this paper,
this result, in hindsight, is well known, and can be found in \cite{Weisstein13}.
This paper shows a derivision using the language of geometric algebra.
...
% There may certainly be an easier way to arrive at this result using
...
\begin{equation*}
\bigwedge_{j=1}^i\nabla_j =
-(-1)^i \sum_{j_1=1}^n\dots\sum_{j_i=1}^n\bigwedge_{k=1}^i e_{k,j_k}\prod_{k=1}^i\nabla_{e_{j_k}},
\end{equation*}
