...
of up to this degree.  If polynomials of a higher degree are needed, simply go to
...
&=\bigwedge_{i=1}^m p_i(x)\cdot\bigwedge_{i=1}^m V_iB_iV_i^{-1} \\
&=\bigwedge_{i=1}^m p_i(x)\cdot\bigwedge_{i=1}^m VB_iV^{-1} \\
