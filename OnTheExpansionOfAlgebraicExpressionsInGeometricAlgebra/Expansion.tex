...
\end{equation}
Recalling also the commutativities of $a$ with $B_r$ in the inner and outer products, we find that
\begin{align}
a\cdot B_r &= \frac{1}{2}(aB_r-(-1)^rB_ra),\label{equ_a_dot_Br} \\
a\wedge B_r &= \frac{1}{2}(aB_r+(-1)^rB_ra).\label{equ_a_wedge_Br}
\end{align}
