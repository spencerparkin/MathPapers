...
of $p$, gives us the set of all non-zero null-vectors in $\V$.  That is, the set of all non-zero null vectors in $\V$
is given by
\begin{equation*}
...
of the form $\lambda p(y)$ since it is clearly also non-zero.
