...
Although a well known result, (see \cite{Weisstein13}),
this paper shows a derivision using the language of geometric algebra,
and its suitability to the task.
...
\begin{equation*}
\bigwedge_{j=1}^i\nabla_j =
-(-1)^i \sum_{j_1=1}^n\dots\sum_{j_i=1}^n\bigwedge_{k=1}^i
e_{k,j_k}\prod_{k=0}^{i-1}\nabla_{e_{j_{i-k}}},
\end{equation*}
