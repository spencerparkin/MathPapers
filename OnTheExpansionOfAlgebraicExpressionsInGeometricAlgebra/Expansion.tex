...
a\cdot M_r &= (a\cdot M_{r-1})m_r - (-1)^r(a\cdot m_r)M_{r-1}\nonumber \\
 &- \langle M_{r-1}\rangle_0am_r + (\langle M_{r-1}\rangle_1\cdot m_r)a.\label{equ_a_dot_Mr_recursive}
\end{align}
Applied recursively, it is now easy to see here from equation \eqref{equ_a_dot_Mr_recursive} that the expansion of
...
Indeed, the outer and geometric products do appear to have some natural symmetry between them.  But this really shouldn't be
too supprising after one compares equation \eqref{equ_ab_is_a_dot_b_and_a_wedge_b} to that of \eqref{equ_a_wedge_b_is_neg_a_dot_b_and_ab}.
