...
\begin{equation*}
(x_1^2+(x_2+1)^2)\cos^2\theta - x_3^2\sin^2\theta = 0,\mbox{wrong!}
\end{equation*}
...
$B$ with $\lambda^{-1}C\wedge e_3$ in equations \eqref{} and \eqref{}.}
...
% lemma blah gives a necessary but insufficient condition for producing a determined system.
