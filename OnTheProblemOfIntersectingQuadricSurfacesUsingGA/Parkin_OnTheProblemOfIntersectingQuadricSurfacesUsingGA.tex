...
have $x\in\gh(B_0)$; and for all $x$ in the second partitoin, we have $x\in\gh(B_1)$.
...
Symbolic computation software was used by the author to do this.}
...
not hard to show that $\gh(B)\subseteq\gh(v\cdot B)$.  Note that it may
...
and any properties we can derive from it.
