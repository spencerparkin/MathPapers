...
this paper shows a derivation using the language of geometric algebra,
...
and so the reader must know exactly what is going on if there is
to be any hope of success in communicating ideas.
...
most often denotes membership in an algebra or space outside of $\G$,
...
\end{equation*}
where $\{e_{i,j}\}_{j=1}^n$ is an orthonormal basis for $\R^n_i$.
