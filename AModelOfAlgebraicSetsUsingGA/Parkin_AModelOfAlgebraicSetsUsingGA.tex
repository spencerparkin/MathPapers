...
\begin{lem}[The Union Of Geometries]\label{lma_union_geos}
...
\end{equation*}
The blade $C$ make now be taken as an outer product of all $A_i'\wedge B_j'$
...
Geometric algebra doesn't seem to be going to work for us without the need
...
% can we relate these using duals?  is this even significant?

\section{Transforming The Geometries of $\G(\V)$}

% knowing how pi transforms allows us to know how any algebraic
% set transforms under a certain versor.
