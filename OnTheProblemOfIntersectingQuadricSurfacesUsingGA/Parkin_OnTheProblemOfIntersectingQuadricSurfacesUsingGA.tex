...
is an under-determinant system, then the system of equations generated by,
...
\end{lem}
\begin{proof}
For a set of $j-1$ scalars $\{\lambda_i\}_{i=1}^{j-1}\subset\R$, letting $p(x_j)=\sum_{i=1}^{j-1}\lambda_i p(x_i)$,
