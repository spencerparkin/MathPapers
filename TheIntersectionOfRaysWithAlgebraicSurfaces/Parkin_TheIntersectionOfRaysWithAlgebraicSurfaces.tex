...
If for an $i$-blade-valued function $f$ with $i<m$, we have, for all vectors $v\in\V_j$ and all
$x\in\R^n$, $v\wedge f(x)\neq 0$, the function $\nabla_j\wedge f$ is $(i+1)$-blade-valued.
If for an $i$-blade-valued function $f$ with $i>0$, we have, for all vectors $v\in\V_j$ and all $x\in\R^n$,
$v\wedge f(x)=0$, the function $\nabla_j\cdot f$ is $(i-1)$-blade-valued.
