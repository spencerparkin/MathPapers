...
and they share the peculiar relationship $\nvai\cdot\nvao=\nvao\cdot\nvai=-1$.  The geometric
...
and $b\in\V_j$, we have $a\cdot b=0$.  We will refer to $\G=\cup_{i=1}^m \G_i$ as the mother Minkowski
algebra of order $m$.
...
formally introduce it, because the equations still go through in its absence.
...
$v\in\V_i$ exists such that $v\wedge B=0$, we must have $\Gd(B)=\R^n$.  We will therefore limit our attention
