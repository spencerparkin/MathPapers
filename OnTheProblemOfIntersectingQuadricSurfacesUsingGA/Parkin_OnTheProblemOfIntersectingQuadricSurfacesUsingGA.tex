...
$\{x_i\}_{i=1}^k$ into two non-empty sets, one of size $j=\grade(B_0)$ with $0<j<k$, and
the other of size $k-j=\grade(B_1)$, such that for all $x$ in the first partition, we
