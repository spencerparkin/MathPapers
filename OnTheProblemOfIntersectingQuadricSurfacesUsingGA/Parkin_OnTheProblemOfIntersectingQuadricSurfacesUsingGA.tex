...
algebra, (see\cite{Hestenes01,Dorst07}), but not limited in representation to any proper subset of the set of all
...
algorithm;\footnote{A better blade factorization algorithm can been found in \cite{}, but remember, we're not looking
