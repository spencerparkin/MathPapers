...
% Possible next steps...
%   1) Formulate a canonical form, axis-aligned.
%   2) Can it be reduced in grade?
%   3) Calculate an intersection to match the canonical form.
%   4) Can it be reduced in grade?
%   5) If the calculated intersection and the canonical form are both of the same reduced grade, we can equate them.
